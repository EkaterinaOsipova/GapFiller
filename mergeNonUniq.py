...
def main():
    ...
    with open(args.output, 'w') as ouf:
        ...
        for nid in nonUniqIDs:
            ...
            mergedChainStr = runAxtConversions(args.tempStore, args.T2bit, args.Q2bit)
...
def runAxtConversions(oneIDfile, T2, Q2):
    commandChainToAxt = "chainToAxt {0} {1} {2} stdout".format(oneIDfile, T2, Q2)
    commandAxtChain = "axtChain -linearGap=loose stdin {0} {1} stdout ".format(T2, Q2)
